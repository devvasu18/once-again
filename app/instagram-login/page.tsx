...
export default function IGLoginPage() {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">IG Login</h1>
            <p className="text-gray-600">Connect your IG account to start analyzing</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">IG</h2>
          </div>
